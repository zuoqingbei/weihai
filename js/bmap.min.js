            ...
            return t.dimensions = t.prototype.dimensions, t.create = function (e, o) {
                ...
                e.eachComponent("bmap", function (e) {
                    ...
                    if (!e.__bmap) {
                        ...
                        var c = e.__bmap = new BMap.Map(s), m = new i(p);
                        c.addOverlay(m)
                    }
        ...
        n = function (e) {
            return o(1).extendComponentView({
                type: "bmap", render: function (e, t, o) {
                    ...
                    var r = !0, i = e.getBMap(), a = o.getZr().painter.getViewportRoot(), p = e.coordinateSystem, s = function (t, n) {
                        if (!r) {
                            var i = a.parentNode.parentNode.parentNode, s = [-parseInt(i.style.left, 10) || 0, -parseInt(i.style.top, 10) || 0];
                            a.style.left = s[0] + "px", a.style.top = s[1] + "px", p.setMapOffset(s), e.__mapOffset = s, o.dispatchAction({type: "bmapRoam"})
                        }
                    };
