...
(function(factory) {
  ...
  var _globaloptions = {
	...
	verticaldisabled: false,  // dundicat add parameter
    railalign: "right",
    railvalign: "bottom",
...
*/              
    ...
    this.onResize = function(e, page) {
      ...
      if (!self.haswrapper && !self.ispage) {
		...
		//**************dundicat modify ******************//
         // if (!self.hidden && !self.visibility) self.showRail().showRailHr();  //原来部分
		  if (self.rail && (!self.hidden && !self.rail.visibility)) self.showRail();
		  if (self.railh && (!self.hidden && !self.railh.visibility)) self.showRailHr();
		//**************dundicat modify end******************//
        }
      }
	  ...
	  if(self.opt.verticaldisabled)  self.hideRail(); // dundicat add
